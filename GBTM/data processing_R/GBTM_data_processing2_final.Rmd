...
```{r}
admission_30NA <- read_excel("~/Desktop/datasets/processed/Filtered Attributes Admission v2.xlsx", sheet = 'NA30_filtered_admission')
...
```{r}
dim(admission_lab[which(admission_lab$GLUCOSE > 750),])
admission.glucose[[measure]][which(admission_lab[[measure]]> 750)]  <- NA_real_
```
